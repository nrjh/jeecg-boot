  ...
  <a-drawer
    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="节点级别
1-库房 2-库区 3-货架 4-货位" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number v-decorator="[ 'storeLevel', validatorRules.storeLevel]" placeholder="请输入节点级别
1-库房 2-库区 3-货架 4-货位" style="width: 100%"/>
        </a-form-item>
        <a-form-item label="父级节点" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="[ 'storeParent', validatorRules.storeParent]" placeholder="请输入父级节点"></a-input>
        </a-form-item>
        <a-form-item label="节点状态
1-启用 0-禁用" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="[ 'storeStatus', validatorRules.storeStatus]" placeholder="请输入节点状态
1-启用 0-禁用"></a-input>
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/reserve.store/oReserveStore/add",
          edit: "/reserve.store/oReserveStore/edit",
        }
      }
    },
    created () {
