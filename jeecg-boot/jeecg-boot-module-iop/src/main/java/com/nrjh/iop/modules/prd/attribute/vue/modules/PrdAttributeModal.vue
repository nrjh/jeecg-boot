    ...
    <a-spin :spinning="confirmLoading">
      ...
      <a-form :form="form">
        <a-row>
          ...
          <a-col :span="12">
            <a-form-item label="显示类型(radio:单选按钮; select:下拉框;color:颜色)" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-dict-select-tag type="list" v-decorator="['displayType', validatorRules.displayType]" :trigger-change="true" dictCode="IOP_PRD_DISPLAY_TYPE" placeholder="请选择显示类型(radio:单选按钮; select:下拉框;color:颜色)"/>
            </a-form-item>
          </a-col>
    ...
    data() {
      return {
        ...
        validatorRules: {
          ...
          displayType: {rules: [
            {required: true, message: '请输入显示类型(radio:单选按钮; select:下拉框;color:颜色)!'},
          ]},
        },
        ...
        url: {
          add: "/prd.attribute/prdAttribute/add",
          edit: "/prd.attribute/prdAttribute/edit",
          prdAttributeValue: {
            list: '/prd.attribute/prdAttribute/queryPrdAttributeValueByMainId'
          },
        }
      }
    },
