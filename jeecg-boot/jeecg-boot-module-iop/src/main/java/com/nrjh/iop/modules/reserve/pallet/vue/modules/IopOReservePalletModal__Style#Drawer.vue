...
1-启用 0-禁用" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="[ 'storeStatus', validatorRules.storeStatus]" placeholder="请输入托盘状态
1-启用 0-禁用"></a-input>
        </a-form-item>
        <a-form-item label="是否虚拟
1-是 0-否" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="[ 'storeIsvirtual', validatorRules.storeIsvirtual]" placeholder="请输入是否虚拟
1-是 0-否"></a-input>
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/reserve.pallet/iopOReservePallet/add",
          edit: "/reserve.pallet/iopOReservePallet/edit",
        }
      }
    },
    created () {
