package com.nrjh.iop.modules.stk.picking.vo;
 ...
 */
@Data
@ApiModel(value="stk_pickingPage对象", description="调拨单")
public class StkPickingPage {
	...
	@ExcelCollection(name="移库单")
	@ApiModelProperty(value = "移库单")
	private List<StkMove> stkMoveList;
