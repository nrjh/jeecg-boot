 ...
 * @since 2018-12-28
 */
public interface IopSysDictMapper extends BaseMapper<IopSysDict> {
	 ...
	 * @return
	 */
	List<IopTreeSelectModel> queryTreeList(@Param("query") Map<String, String> query, @Param("table") String table, @Param("text") String text, @Param("code") String code, @Param("pidField") String pidField, @Param("pid") String pid, @Param("hasChildField") String hasChildField);
