 ...
 */
@Data
@ApiModel(value="prd_productPage对象", description="物品")
public class PrdProductPage {
	...
	@ExcelCollection(name="物品属性值关系")
	@ApiModelProperty(value = "物品属性值关系")
	private List<PrdProductAttrValueRel> prdProductAttrValueRelList;
