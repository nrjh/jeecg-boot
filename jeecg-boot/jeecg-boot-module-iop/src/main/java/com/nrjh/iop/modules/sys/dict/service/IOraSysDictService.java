 ...
 * @since 2018-12-28
 */
public interface IOraSysDictService extends IService<IopSysDict> {
     ...
     * @return
     */
    boolean deleteByDictId(IopSysDict IopSysDict);
	 ...
	 * @return
	 */
	List<IopTreeSelectModel> queryTreeList(Map<String, String> query, String table, String text, String code, String pidField, String pid, String hasChildField);
