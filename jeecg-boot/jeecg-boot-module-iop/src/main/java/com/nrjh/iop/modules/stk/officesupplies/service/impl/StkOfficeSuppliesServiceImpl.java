package com.nrjh.iop.modules.stk.officesupplies.service.impl;
...
import com.nrjh.iop.modules.stk.officesupplies.mapper.StkOfficeSuppliesMapper;
...
@Service
@DS("iop")
public class StkOfficeSuppliesServiceImpl extends ServiceImpl<StkOfficeSuppliesMapper, StkSpareParts> implements IStkOfficeSuppliesService {
...
//        if(!BeanUtil.isEmpty(prdProduct)){
//            prdProductService.delMain(proID+"");
//            prdProduct = new PrdProduct();
//        }else{
//            return;
//        }
        ...
        // 更新返回前端数据
        // 这个叫chenchao的老哥，写得代码太tm垃圾了，我顶不住了 死马当废马医
