...
class DbReadTableUtilTest {
    private static final Logger a = LoggerFactory.getLogger(DbReadTableUtilTest.class);
    private static Connection b;
    private static Statement c;

    public DbReadTableUtilTest() {
    }
    ...
    public static List<String> a() throws SQLException {
        ...
        try {
            ...
            if (org.jeecgframework.codegenerate.a.a.a.equals("mysql")) {
                var1 = MessageFormat.format("select distinct table_name from information_schema.columns where table_schema = {0}", org.jeecgframework.codegenerate.generate.util.c.c(org.jeecgframework.codegenerate.a.a.f));
            }

            if (org.jeecgframework.codegenerate.a.a.a.equals("oracle")) {
                var1 = " select distinct colstable.table_name as  table_name from user_tab_cols colstable order by colstable.table_name";
            }

            if (org.jeecgframework.codegenerate.a.a.a.equals("postgresql")) {
                var1 = "select tablename from pg_tables where schemaname='public'";
            }

            if (org.jeecgframework.codegenerate.a.a.a.equals("sqlserver")) {
    ...
    public static List<ColumnVo> a(String var0) throws Exception {
        ...
        try {
            ...
            var6 = new ColumnVo();
            if (org.jeecgframework.codegenerate.a.a.l) {
            ...
            var6.setNullable(org.jeecgframework.codegenerate.generate.util.c.a(var1.getString(7)));
            a(var6);
            var6.setFiledComment(StringUtils.isBlank(var1.getString(3)) ? var6.getFieldName() : var1.getString(3));
            String[] var7 = new String[0];
            if (org.jeecgframework.codegenerate.a.a.p != null) {
                var7 = org.jeecgframework.codegenerate.a.a.p.toLowerCase().split(",");
            }

            if (!org.jeecgframework.codegenerate.a.a.m.equals(var6.getFieldName()) && !org.jeecgframework.codegenerate.database.util.a.a(var6.getFieldDbName().toLowerCase(), var7)) {
                var3.add(var6);
            }
            ...
            while(var1.previous()) {
                ...
                if (!org.jeecgframework.codegenerate.a.a.m.equals(var8.getFieldName()) && !org.jeecgframework.codegenerate.database.util.a.a(var8.getFieldDbName().toLowerCase(), var7)) {
                    ...
                    var8.setNullable(org.jeecgframework.codegenerate.generate.util.c.a(var1.getString(7)));
                    a(var8);
    ...
    public static List<ColumnVo> b(String var0) throws Exception {
        ...
        try {
            ...
            var6.setFieldDbName(var1.getString(1).toUpperCase());
            var6.setPrecision(org.jeecgframework.codegenerate.generate.util.c.b(var1.getString(4)));
            var6.setScale(org.jeecgframework.codegenerate.generate.util.c.b(var1.getString(5)));
            var6.setCharmaxLength(org.jeecgframework.codegenerate.generate.util.c.b(var1.getString(6)));
            var6.setNullable(org.jeecgframework.codegenerate.generate.util.c.a(var1.getString(7)));
            ...
            while(var1.previous()) {
                ...
                var7.setPrecision(org.jeecgframework.codegenerate.generate.util.c.b(var1.getString(4)));
                var7.setScale(org.jeecgframework.codegenerate.generate.util.c.b(var1.getString(5)));
                var7.setCharmaxLength(org.jeecgframework.codegenerate.generate.util.c.b(var1.getString(6)));
                var7.setNullable(org.jeecgframework.codegenerate.generate.util.c.a(var1.getString(7)));
    ...
    public static boolean c(String var0) {
        ...
        try {
            ...
            c = b.createStatement(1005, 1007);
            if (org.jeecgframework.codegenerate.a.a.a.equals("mysql")) {
                // var2 = "select column_name,data_type,column_comment,0,0 from information_schema.columns where table_name = '" + var0 + "' and table_schema = '" + org.jeecgframework.codegenerate.a.a.f + "'";
                // 替换回车换行后，截取第一个空格前字符  update by zzy 20200513
                var2 = "select column_name,data_type,substring_index(REPLACE(REPLACE(column_comment, CHAR(10), ''), CHAR(13), ''), ' ', 1) column_comment,0,0 from information_schema.columns where table_name = '" + var0 + "' and table_schema = '" + org.jeecgframework.codegenerate.a.a.f + "'";
