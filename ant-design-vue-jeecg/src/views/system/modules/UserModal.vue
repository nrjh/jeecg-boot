    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="班组" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-dict-select-tag-ora type="list" v-decorator="['shiftId', validatorRules.shiftId]"
                                 @inputText="inputTextShiftId"
                                 :trigger-change="true" dictCode="O_SHIFT,SHIFT_NAME,SHIFT_ID" placeholder="请选择班组"/>
          <a-input v-show="false" v-decorator="['shiftName']"></a-input>
        </a-form-item>
