         ...
         <a-row :gutter="24">
           ...
           <a-col :span="8">
             <a-form-item label="名称" :labelCol="labelCol" :wrapperCol="wrapperCol">
               <a-input  placeholder="请输入物料名称" v-model='name'></a-input>
             </a-form-item>
           </a-col>
           <a-col :span="8">
         ...
         <a-row :gutter="24">
           <a-col :span="8">
             <a-form-item label="供应商" :labelCol="labelCol" :wrapperCol="wrapperCol">
               <a-input  placeholder="请输入供应商信息" v-model='mproVendorId'></a-input>
             </a-form-item>
           </a-col>
           <a-col :span="8">
         ...
         <a-row :gutter="24">
           <a-col :span="8">
             <a-form-item label="库房" :labelCol="labelCol" :wrapperCol="wrapperCol">
               <JDictSelectTagIop :triggerChange="true"
                                  placeholder="请选择库房"
                                  dictCode="stk_warehouse,name,id" v-model='mlocationId'/>
             </a-form-item>
           </a-col>
         </a-row>
...
//          },
    ...
    methods: {
      ...
      handleAddQueryBtn(){
        getAction(this.url.list, {name : this.name,productNo : this.mproNo,attributeCategoryId : this.mproCategoryId,vendorId : this.mproVendorId,
