    ...
    <a-spin :spinning="confirmLoading">
      ...
      >
        ...
        <template slot="productActualQty" slot-scope="text,record,index">
          <span>{{stockInOrderLineTable.dataSource[index].productActualQty}}</span>
          <!--<a-input-number v-model="stockInOrderLineTable.dataSource[index].productActualQty"/>-->
        </template>

        <template slot="priceUnit" slot-scope="text,record,index">
          <!--<a-input-number v-model="stockInOrderLineTable.dataSource[index].priceUnit"/>-->
          <span>{{stockInOrderLineTable.dataSource[index].priceUnit}}</span>
        </template>

        <template slot="completeTime" slot-scope="text,record,index">
          <span >{{stockInOrderLineTable.dataSource[index].completeTime}}</span>
        </template>

        <template slot="action" slot-scope="text,record,index">
          <a  @click="handleDistribution(index)">查看货位</a>
        </template>
...
/*            {
            ...
            },
            {
              ...
              customRender: function(t, r, index) {
                return r.priceUnit * r.productUomQty
              }
            },
            {
              title: '入货位时间',
    ...
    methods: {
      ...
      editAfter() {
        ...
        console.log("stockInOrderLineTable.dataSource",this.stockInOrderLineTable.dataSource)
        this.editable = true
      ...
      handleDistribution(index) {
        ...
        let orderInfo = {}
        orderInfo.partnerid = this.form.getFieldValue('partnerId')
        ...
        this.$refs.distributionProdFrom.add(orderInfo, false)
      },
      handleDelete(index) {
