...
<!-- 查看按钮弹出表单 办公用品查看页面-->
  <a-modal
    :title="title1"
    :width="width"
    :visible="visibleLookOfficeSuppliesModel"
...
export default {
  ...
  data() {
    return {
      ...
      stockWarn: '',
      remark: '',
      visibleLookOfficeSuppliesModel: false,
      labelCol: {
        span: 6
      },
      wrapperCol: {
  ...
  methods: {
    handleCancelCheck(){
      this.visibleLookOfficeSuppliesModel=false;
    },
    handleOKCheck(){
      this.visibleLookOfficeSuppliesModel=false;
    },
   showCheck(sparePartsId){
     this.visibleLookOfficeSuppliesModel=true;
