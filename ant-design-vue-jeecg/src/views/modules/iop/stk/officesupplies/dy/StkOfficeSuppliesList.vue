...
<!--              </a>-->
    ...
    <stkOfficeSupplies-modal ref="modalForm" @ok="modalFormOk"></stkOfficeSupplies-modal>
...
<script>
  ...
  import StkOfficeSuppliesModal from './modules/StkOfficeSuppliesModal.vue'
  import lookOfficeSuppliesModal from './modules/lookOfficeSuppliesModal.vue'
  import JDictSelectTag from '@/components/dict/JDictSelectTag.vue'

  export default {
    name: "StkOfficeSuppliesList",
    mixins:[JeecgListMixin],
    components: {
      JDictSelectTag,
      StkOfficeSuppliesModal,
