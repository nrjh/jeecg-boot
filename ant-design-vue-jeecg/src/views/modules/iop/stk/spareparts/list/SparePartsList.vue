...
<!--                              dictCode="IOP_PRD_CATEGORY_ID" v-model='queryParam.categoryId'/>-->
        ...
        <a-row :gutter="24">
          ...
          <a-col :xl="8" :lg="7" :md="8" :sm="24">
            <a-form-item label="入库日期"  v-if="this.toggleSearchStatus">
              <j-date  placeholder="请选择开始时间" v-model="queryParam.startEnterDate"  :trigger-change="true" style="width: 100%"/>
            </a-form-item>
          </a-col>
          <a-col :xl="8" :lg="7" :md="8" :sm="24">
            <a-form-item label="至"  v-if="this.toggleSearchStatus">
              <j-date  placeholder="请选择结束时间" v-model="queryParam.endEnterDate" :trigger-change="true" style="width: 100%"/>
            </a-form-item>
          </a-col>
...
<script>
  ...
  import lookSparePartsModal from '../list/modules/lookSparePartsModal.vue'
