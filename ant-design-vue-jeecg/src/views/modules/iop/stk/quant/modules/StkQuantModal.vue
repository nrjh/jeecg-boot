    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="物品" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-dict-select-tag-iop type="list" v-decorator="['productId', validatorRules.productId]" :trigger-change="true" dictCode="PRD_PRODUCT,NAME,ID" placeholder="请选择物品"/>
        </a-form-item>
        <a-form-item label="批次/序列号" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-dict-select-tag-iop type="list" v-decorator="['productLotId', validatorRules.productLotId]" :trigger-change="true" dictCode="stk_production_lot,name,id" placeholder="请选择批次/序列号"/>
        </a-form-item>
        <a-form-item label="仓库位置" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-search-select-tag-iop v-decorator="['locationId', validatorRules.locationId]" dict="stk_location,complete_name,id" />
        </a-form-item>
        ...
        <a-form-item label="单位" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-dict-select-tag-iop type="list" v-decorator="['companyId', validatorRules.companyId]" :trigger-change="true" dictCode="uom_uom,name,id" placeholder="请选择单位"/>
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/iop/stk/quant/add",
          edit: "/iop/stk/quant/edit",
        }
      }
    },
    created () {
