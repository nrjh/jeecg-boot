...
<!--              </a>-->
    ...
    <div class="table-operator">
      ...
      <!--
      <a-button type="primary" icon="download" @click="handleExportXls('库房')">导出</a-button>
    ...
    <stkWarehouse-modal ref="modalForm" @ok="modalFormOk"></stkWarehouse-modal>
    <stkWarehouse-modalView ref="modalFormView" @ok=""></stkWarehouse-modalView>
  </a-card>
</template>
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: '/iop/stk/warehouse/list',
          delete: '/iop/stk/warehouse/delete',
          deleteBatch: '/iop/stk/warehouse/deleteBatch',
          exportXlsUrl: '/iop/stk/warehouse/exportXls',
          importExcelUrl: '/iop/stk/warehouse/importExcel'
        },
        dictOptions: {}
      }
    },
