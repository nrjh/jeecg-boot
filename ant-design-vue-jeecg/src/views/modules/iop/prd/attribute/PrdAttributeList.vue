        ...
        <a-row :gutter="24">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="显示类型">
              <j-dict-select-tag placeholder="请选择显示类型" v-model="queryParam.displayType" dictCode="IOP_PRD_DISPLAY_TYPE"/>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/iop/prd/attribute/list",
          delete: "/iop/prd/attribute/delete",
          deleteBatch: "/iop/prd/attribute/deleteBatch",
          exportXlsUrl: "/iop/prd/attribute/exportXls",
          importExcelUrl: "/iop/prd/attribute/importExcel",
        },
        dictOptions:{},
      }
    },
